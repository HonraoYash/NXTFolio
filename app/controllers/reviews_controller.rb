...
class ReviewsController < ApplicationController
  ...
  def create
    ...
    if @review.save
      RatingMailer.gallery_rating_email(@general_info.emailaddr, @general_info.first_name,
                                        "#{@user.first_name} #{@user.last_name}", @gallery.gallery_title, @review.rating).deliver_now!
