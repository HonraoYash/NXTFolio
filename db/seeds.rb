...
Country.transaction do
  countries.each_with_index do |country, idx|
    ...
    phone_code = phone_code.start_with?('+') ? phone_code[1..] : phone_code
...
filenames = ['Andrea-Piacquadio.jpg', 'Anthony-Gray.jpg', 'Jack-Winbow.jpg', 'James-Lawrence.jpg', 'Masha-Raymers.jpg',
             'Tasha-Washington.jpg']
job_names = ['Brand Owner', 'Designer', 'Other Creator', 'Model', 'Photographer', 'Sales', 'Marketing', 'Retail',
             'Visual', 'Content Creator', 'Blogger', 'Influencer', 'Forecasting', 'Finances', 'Other Services', 'Manufacturing', 'Materials', 'Other Makers']
...
(1..filenames.length).each do |i|
  ...
  (1..3).each do |_j|
    ...
    if !Follow.exists?(follower:, followee:) && (i != random_user)
