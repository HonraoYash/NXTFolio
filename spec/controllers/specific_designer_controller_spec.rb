...
RSpec.describe SpecificDesignerController, type: :controller do
  ...
  describe 'POST #create' do
    it 'should create SpecificDesigner' do
      post :create,
           params: { specific_designer: { influencers: 'Me', specialties: 'Being cool', compensation: 'Any',
  ...
  describe 'GET #edit' do
    it 'should get SpecificDesigner' do
      ...
      @specific_designer = SpecificDesigner.create(influencers: 'Me', specialties: 'Being cool', compensation: 'Any',
                                                   experience: '11+ years', genre: 'Acting', user_key: session[:current_user_key])
  ...
  describe 'POST #update' do
    it 'should update SpecificDesigner' do
      session[:current_user_key] = SecureRandom.hex(10)
      SpecificDesigner.create(influencers: 'Me', specialties: 'Being cool', compensation: 'Any',
                              experience: '11+ years', genre: 'Acting', user_key: session[:current_user_key])
      post :update,
           params: { specific_designer: { influencers: 'Me', specialties: 'Being cool', compensation: '$100,000',
                                          experience: '11+ years', genre: 'Acting' } }
      expect(response).to redirect_to show_profile_show_profile_path
    end
  end
  ...
  describe 'DELETE #destroy' do
    it 'should delete SpecificDesigner' do
      @specific_designer = SpecificDesigner.create(influencers: 'Me', specialties: 'Being cool', compensation: 'Any',
                                                   experience: '11+ years', genre: 'Acting', user_key: SecureRandom.hex(10))
