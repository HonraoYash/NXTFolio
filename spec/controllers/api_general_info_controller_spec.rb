  ...
  describe 'GET#index' do
    it 'should get the general info table and show the last access time if the user is not new' do
      general_info = GeneralInfo.create(first_name: 'R', last_name: 'Spec',
                                        highlights: 'test highlights', company: 'test company', industry: 'test industry', emailaddr: 'test@gmail.com', phone: 892, month_ofbirth: 0o1, day_ofbirth: 31, year_ofbirth: 1985, gender: 'Female', country: 'United States', state: 'TX', city: 'Austin', userKey: SecureRandom.hex(10))
