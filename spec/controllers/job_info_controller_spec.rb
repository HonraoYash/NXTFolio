...
RSpec.describe JobInfoController, type: :controller do
  ...
  describe 'GET#search' do
    it 'should search the job info when keyword is present in tile and description' do
      JobInfo.create(country: 'United States', state: 'California', city: 'San Jose', profession: 'Designer',
      ...
      get :search,
          params: { Country: 'United States', State: 'California', City: 'San Jose', Profession: 'Designer',
                    Category: 'Creators', Keyword: 'test' }
    end
  ...
  describe 'GET#show' do
    it 'should show the job' do
      job_info = JobInfo.create(country: 'United States', state: 'California', city: 'San Jose',
