...
RSpec.describe SpecificPhotographerController, type: :controller do
  ...
  describe 'POST #create' do
    it 'should create SpecificPhotographer' do
      post :create,
           params: { specific_photographer: { influencers: 'Me', specialties: 'Being cool', compensation: 'Any',
  ...
  describe 'POST #update' do
    it 'should update SpecificPhotographer' do
      session[:current_user_key] = SecureRandom.hex(10)
      SpecificPhotographer.create(influencers: 'Me', specialties: 'Being cool', compensation: 'Any',
                                  experience: '11+ years', genre: 'Acting', user_key: session[:current_user_key])
      post :update,
           params: { specific_photographer: { influencers: 'Me', specialties: 'Being cool', compensation: '$100,000',
                                              experience: '11+ years', genre: 'Acting' } }
      expect(response).to redirect_to show_profile_show_profile_path
    end
  end
